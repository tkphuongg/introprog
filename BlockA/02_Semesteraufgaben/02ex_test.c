...
static TestCase test_cases2[TEST_CASES_2] = {
    {.len = 36, .arr = NULL, .count = 36, .name = "swap_sort1", .file_in = "swap_sort1.png"},
    {.len = 25, .arr = NULL, .count = 25, .name = "swap_sort2", .file_in = "swap_sort2.png"},
    {.len = 9, .arr = NULL, .count = 9, .name = "swap_sort3", .file_in = "swap_sort3.png"},
    {.len = 2, .arr = NULL, .count = 2, .name = "swap_sort4", .file_in = "swap_sort4.png"},
    {.len = 1, .arr = NULL, .count = 1, .name = "swap_sort5", .file_in = "swap_sort5.png"},
};
...
int main(int argc, char const *argv[]) {
    ...
    // /* Aufgabe 2*/
    if (begin_exercise(&tester, "swap_sort", "Aufgabe 2: swap_sort."))
    {
        for (size_t i = 0; i < TEST_CASES_2; i++) {
            if(begin_testcase(&tester)) {
                ...
                swap_sort(&v, input_arr, test_cases2[i].len);
