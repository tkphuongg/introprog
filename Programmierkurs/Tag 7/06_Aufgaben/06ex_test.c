...
char* render_exercise_1b(Canvas t, exercise_1b_data testcase)
{
    ...
    for(int i = 0; i < testcase.number_of_pixels; i++){
        ...
        snprintf(temp_string,120,TESTRUNNER_LABEL "\t\t%zu. Pixel mit den Koordinaten: (%d,%d), Channel: %s "
...
char* render_exercise_2b(Canvas t, exercise_2b_data testcase)
{
    ...
    for(int i = 0; i < testcase.number_of_pixels; i++){
        ...
        snprintf(temp_string,120,TESTRUNNER_LABEL "\t\t%zu. Pixel mit den Koordinaten: (%d,%d) "
